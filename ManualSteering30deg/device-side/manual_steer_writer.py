...
# NORMAL: 20 deg — 25 deg margin to Panda max_angle 45 deg (byd.h, confirmed).
# HIGH:   30 deg — 15 deg margin to Panda max_angle 45 deg.
...
WRITER_ABS_MAX_DEG_NORMAL = 20.0
WRITER_ABS_MAX_DEG_HIGH   = 30.0
